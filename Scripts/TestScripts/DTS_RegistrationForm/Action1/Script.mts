...
confirmationMessage= Browser("Home - GlobalSQA").Page("AngularJS User Registration").WebElement("innertext:=Registration successful").getROProperty("innertext")
    ' Step 5: Verification
    If confirmationMessage = "Registration successful"  Then 
        result = "Passed" & i
    Else
     result = "Failed" & i
    End If
...
WriteResultToExcel "AngularJS_PracticeSet_RegistrationForm",  "Verify if user successfully registered for user" & i , "Registration successful.", confirmationMessage, result, "G:\UFT Projects\GlobalSqa_Automation_Project\Results\Reports\TestReportSheet.xlsx"
